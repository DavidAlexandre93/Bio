...
export const highlightedProjects = [
  {
    title: 'Website',
    description: 'Site institucional com foco em conversão e design moderno.',
  ...
  {
    title: 'Portfólio',
    description: 'Mostra de cases, stack e resultados com experiência imersiva.',
  ...
  {
    title: 'Bio-Portfolio',
    description: 'Página de links inteligente para acessar recursos rapidamente.',
...
export const socialLinks = [
  {
    title: 'Vercel',
    description: 'Deploys, projetos e presença no ecossistema frontend.',
  ...
  {
    title: 'Linkedin',
    description: 'Perfil profissional com trajetória e recomendações.',
  ...
  {
    title: 'Discord',
    description: 'Comunidade e troca rápida com outros devs.',
  ...
  {
    title: 'GitHub',
    description: 'Repositórios, contribuições e histórico técnico.',
  ...
  {
    title: 'E-mail',
    description: 'Agendamento direto para conversas e parcerias.',
